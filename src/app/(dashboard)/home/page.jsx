            ...
            <div className="mt-4 p-4 bg-gray-800/30 rounded-lg">
              <div className="flex justify-between items-center mb-2">
                <p className="text-xs text-gray-400">
                  Последние транзакции (24ч)
                </p>
                <div className="flex items-center gap-2">
                  <span id="transactionCount" className="text-xs text-teal-400">
              ...
              <div className="h-16 flex items-end gap-1" id="activityGraph">
                <div className="relative group">
                  <div
                    className="w-2 bg-teal-400 rounded-full transition-all duration-300 hover:bg-teal-300"
                ...
                <div className="relative group">
                  <div
                    className="w-2 bg-teal-400/40 rounded-full transition-all duration-300 hover:bg-teal-300"
                ...
                <div className="relative group">
                  <div
                    className="w-2 bg-teal-400/70 rounded-full transition-all duration-300 hover:bg-teal-300"
                ...
                <div className="relative group">
                  <div
                    className="w-2 bg-teal-400/70 rounded-full transition-all duration-300 hover:bg-teal-300"
                    style={{ height: "47.368421052631575%" }}
                  ></div>
                  <div className="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 bg-gray-800 text-xs text-teal-400 px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                    9 tx
                  </div>
                ...
                <div className="relative group">
                  <div
                    className="w-2 bg-teal-400 rounded-full transition-all duration-300 hover:bg-teal-300"
                    style={{ height: "94.73684210526315%" }}
                  ></div>
                  <div className="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 bg-gray-800 text-xs text-teal-400 px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                    18 tx
                  </div>
                ...
                <div className="relative group">
                  <div
                    className="w-2 bg-teal-400/40 rounded-full transition-all duration-300 hover:bg-teal-300"
                    style={{ height: "31.57894736842105%" }}
                  ></div>
                  <div className="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 bg-gray-800 text-xs text-teal-400 px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                    6 tx
                  </div>
                ...
                <div className="relative group">
                  <div
                    className="w-2 bg-teal-400 rounded-full transition-all duration-300 hover:bg-teal-300"
                    style={{ height: "78.94736842105263%" }}
                  ></div>
                  <div className="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 bg-gray-800 text-xs text-teal-400 px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                    15 tx
                  </div>
          ...
          <div className="bg-gray-900/50 rounded-xl p-6 border border-gray-700 hover:border-teal-500/30 transition-colors duration-300">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-gray-800/50 rounded-lg hover:bg-gray-800/70 transition-colors duration-300">
                ...
                <p className="text-2xl font-bold text-white" id="avgTime">
                  0
                </p>
          ...
          <div className="bg-gray-900/50 rounded-xl p-6 border border-gray-700 hover:border-teal-500/30 transition-colors duration-300">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2 bg-gray-800/50 px-3 py-1.5 rounded-full">
                <span id="lastUpdateTime" className="text-xs text-gray-400">
                  Обновлено сейчас
                </span>

                <FaSyncAlt className="text-teal-400 animate-spin text-sm" />
              </div>
            </div>
            <div id="transactionsList" className="space-y-3">
              <LastOperations />
              {/* {lastOperations.map((lastOp) => (
                <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg hover:bg-gray-800/70 transition-all duration-300">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">{lastOp.time}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
